...
save_path = 'C:\\Users\\ARDA  BARIŞ\\Desktop\\new\\Yeni klasör' # TODO: Change this if the outputs are to be saved in another directory

cam_args = {'focal_length': 43e-3,
            'resolution': (4008, 2672),
            'pixel_size': (9e-6, 9e-6),
            'perfect_resolution': True
            }
...
uav = UAV(**uav_args, camera=Camera(**cam_args))
...
#sim.plotEMatrixComputationTime()   # TODO: Uncomment this line if computation plots are to be generated as well
